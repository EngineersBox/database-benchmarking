...
export HBASE_CANARY_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_CANARY_OPTS} -Dotel.resource.attributes=service.name=hbase-canary,node=@@NODE_ID@@"
export HBASE_HBCK_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_HBCK_OPTS} -Dotel.resource.attributes=service.name=hbase-hbck,node=@@NODE_ID@@"
export HBASE_HBTOP_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_HBTOP_OPTS} -Dotel.resource.attributes=service.name=hbase-hbtop,node=@@NODE_ID@@"
export HBASE_JSHELL_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_JSHELL_OPTS} -Dotel.resource.attributes=service.name=hbase-jshell,node=@@NODE_ID@@"
export HBASE_LTT_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_LTT_OPTS} -Dotel.resource.attributes=service.name=hbase-loadtesttool,node=@@NODE_ID@@"
export HBASE_MASTER_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_MASTER_OPTS} -Dotel.resource.attributes=service.name=hbase-master,node=@@NODE_ID@@"
export HBASE_PE_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_PE_OPTS} -Dotel.resource.attributes=service.name=hbase-performanceevaluation,node=@@NODE_ID@@"
export HBASE_REGIONSERVER_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_REGIONSERVER_OPTS} -Dotel.resource.attributes=service.name=hbase-regionserver,node=@@NODE_ID@@"
export HBASE_REST_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_REST_OPTS} -Dotel.resource.attributes=service.name=hbase-rest,node=@@NODE_ID@@"
export HBASE_SHELL_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_SHELL_OPTS} -Dotel.resource.attributes=service.name=hbase-shell,node=@@NODE_ID@@"
export HBASE_THRIFT_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_THRIFT_OPTS} -Dotel.resource.attributes=service.name=hbase-thrift,node=@@NODE_ID@@"
export HBASE_ZOOKEEPER_OPTS="${HBASE_GLOBAL_OPTS} ${HBASE_ZOOKEEPER_OPTS} -Dotel.resource.attributes=service.name=hbase-zookeeper,node=@@NODE_ID@@"
